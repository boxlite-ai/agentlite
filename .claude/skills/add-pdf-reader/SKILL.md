---
name: add-pdf-reader
description: Add PDF reading to AgentLite agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/agentlite.log | grep -i pdf
```
