...
This skill adds Slack support to AgentLite, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/qwibitai/agentlite-slack.git
```
...
>
> The JID format for AgentLite is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.agentlite`
