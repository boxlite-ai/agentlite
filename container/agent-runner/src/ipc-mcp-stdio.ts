/**
 * Stdio MCP Server for AgentLite
...
const chatJid = process.env.AGENTLITE_CHAT_JID!;
const groupFolder = process.env.AGENTLITE_GROUP_FOLDER!;
const isMain = process.env.AGENTLITE_IS_MAIN === '1';
