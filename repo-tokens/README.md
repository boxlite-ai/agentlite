...
```yaml
- uses: boxlite-ai/agentlite/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo                                               | Badge                                                                                      |
| -------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| [AgentLite](https://github.com/qwibitai/AgentLite) | ![tokens](https://raw.githubusercontent.com/qwibitai/AgentLite/main/repo-tokens/badge.svg) |
