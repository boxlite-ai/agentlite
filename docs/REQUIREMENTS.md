...
AgentLite gives you the core functionality without that mess.
...
- Custom `agentlite` MCP server (inside container) provides scheduling tools
...
**AgentLite** - A reference to Clawdbot (now OpenClaw).
